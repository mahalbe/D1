...
namespace ISas.Web.Controllers.Dashboard
{
    ...
    public class NoticeController : Controller
    {
        ...
        public NoticeController(ICommon_NECNRepo noticerepo, ISMSManagementRepo smsMangement, ICommonRepo commonRepo)
        {
        ...
        public JsonResult Common_NECN_CRUD(Common_NECN_MainModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (res.Item1 == 1 && model.Function=="SAVE")
                {
                    ...
                    notification.title = "School Notice";
                    notification.body = "Dear Parents, school notice is uploaded. Kindly check the communication section";
