...
namespace ISas.Web.Controllers.Dashboard
{
    ...
    public class CircularController : Controller
    {
        ...
        public CircularController(ICommon_NECNRepo noticerepo, ISMSManagementRepo smsMangement, ICommonRepo commonRepo)
        {
        ...
        public ActionResult New()
        {
            ...
            model.Function = "SAVE";
            model.SelectionGroups = this._noticeRepo.GetSelectionGroupDetails(_uploadType,Session["UserId"].ToString());
        ...
        public JsonResult Common_NECN_CRUD(Common_NECN_MainModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (res.Item1 == 1 && model.Function == "SAVE")
                {
                    ...
                    notification.title = "School Circular";
                    notification.body = "Dear Parents, school circular is uploaded. Kindly check the communication section";
