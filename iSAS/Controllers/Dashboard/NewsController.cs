...
namespace ISas.Web.Controllers.Dashboard
{
    ...
    public class NewsController : Controller
    {
        ...
        public NewsController(ICommon_NECNRepo noticerepo, ISMSManagementRepo smsMangement, ICommonRepo commonRepo)
        {
        ...
        public JsonResult Common_NECN_CRUD(Common_NECN_MainModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (res.Item1 == 1)
                {
                    ...
                    notification.title = "School News";
                    notification.body = "Dear Parents, school news is uploaded. Kindly check the communication section";
